#ifndef NAVIGATION_TESTS_SCENE_INDICES_HPP
#define NAVIGATION_TESTS_SCENE_INDICES_HPP

namespace NavigationSystemCode
{
    struct NavigationTestsSceneIndices
    {
        static const int BLOCKED_DESTINATION = 0;
        static const int BLOCKED_DESTINATION_WITH_BRIDGE = 1;
        static const int CENTRAL_PASSAGE = 2;
